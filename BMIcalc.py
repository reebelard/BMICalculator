...
messagebox.showwarning(title = "Welcome, User!" , message='Welcome!\nBody Mass Index (BMI) is widely used as an indicator of body fat content.\n')
messagebox.showwarning(title = "Welcome, User!" , message='If you want to calculate your BMI, you have to find out your weight and height first. Once you know these values,click OK and proceed')
...
#ICON
image_icon = PhotoImage(file="ICONS\BMIcalcL.png")
root.iconphoto(False, image_icon)

#TOP
top = PhotoImage(file="ICONS\BMIcalc.png")
...
height = Entry(root,
               ...
               fg="#000",
               bd=0,
               justify=CENTER)  # 'justify' TO align text in center
